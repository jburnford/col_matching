<!-- {"case_id": "calib_gemini_ceylon_0056", "bio_ids": ["tranchell_charles-lancelot_b1870"], "stint_ids": ["Tranchell, C. L___Ceylon___1894"]} -->
# Dossier calib_gemini_ceylon_0056
...
- [PASS] position_sim: best 100 vs bar 60: 'asst. supt. of police' ~ 'Superintendent'
- [FAIL] honour: no shared honour
- [not met] edition_cooccurrence (strict corroboration bonus — same edition-year with colony-agreeing position match; absence is normal even for true matches and is NOT evidence against): 1 agreeing edition-year(s) [1920] pos~100 (bar: >=2)
